...
import 'package:room_finder_flutter/chat/pages/all_users_page.dart';
import 'package:room_finder_flutter/chat/pages/groups_page.dart';
import 'package:room_finder_flutter/chat/pages/profile_page.dart';
...
import 'package:room_finder_flutter/widget/customTabBar.dart';
...
class HomePageChat extends StatefulWidget {
  ...
  const HomePageChat({Key? key, required this.uid}) : super(key: key);

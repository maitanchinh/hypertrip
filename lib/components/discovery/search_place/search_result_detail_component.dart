...
class SearchPlaceDetailComponent extends StatefulWidget {
  ...
  @override
  State<SearchPlaceDetailComponent> createState() =>
      _SearchPlaceDetailComponentState();
}

class _SearchPlaceDetailComponentState
    extends State<SearchPlaceDetailComponent> {

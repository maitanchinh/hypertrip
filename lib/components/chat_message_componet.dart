  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          textDirection:
              isMe.validate() ? TextDirection.rtl : TextDirection.ltr,
          mainAxisSize: MainAxisSize.min,
          mainAxisAlignment:
              isMe.validate() ? MainAxisAlignment.end : MainAxisAlignment.start,
          children: [
            Container(
              decoration: boxDecorationWithRoundedCorners(
                  boxShape: BoxShape.circle, backgroundColor: Colors.grey),
              child: Icon(
                Icons.person,
                size: 35,
              ),
